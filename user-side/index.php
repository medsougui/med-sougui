                ...
                <div class="col-12">
                    <nav class="main-nav">
                        ...
                        <a href="index.php" class="logo">
                            <img src="assets/images/ms.png" width="150px" height="75px"  align="klassy cafe html template">
                        </a>
                        <!-- ***** Logo End ***** -->
                        <!-- ***** Menu Start ***** -->
                        <ul class="nav">
                        ...
                        -->
                            ...
                            <li class="scroll-to-section"><a href="#reservation">login</a></li>
                           <!-- <li class="submenu">
                            ...
                            <li class="scroll-to-section"><a href="#cont">Contact Us</a></li> 
                        </ul>        
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    <div class="contact-form">
                        <form id="contact" action="login.php" method="post">
                          <div class="row">
                            ...
                            <div class="col-lg-12 col-sm-12">
                                <fieldset>
                                  <input name="pwd" type="password" id="name" placeholder="password" required="">
                                </fieldset>
                              </div>
                              <?php
                              if($_SESSION['err']==true){
                            echo "<div class='col-lg-12 col-sm-12 ' style='color: red'>
                                <fieldset>
                                    <p style='color : red'>
                                        user or password uncoorect
                                    </p>
                                </fieldset>
                            </div>";}
                            ?>
                    ...
                    <div class="col-lg-6">
                        <div class="contact-form">
                            <form id="contact" action="ajoututilisatuer.php" method="post">
                              <div class="row">
                                <div class="col-lg-12">
                                    <h4>create acount</h4>
                                </div>
                                ...
                                <div class="col-lg-6 col-sm-12">
                                    <fieldset>
                                      <input name="prenom" type="text" id="name" placeholder="Your LastName*" required="">
                                    </fieldset>
                                  </div>
                                <div class="col-lg-6 col-sm-12">
                                  <fieldset>
                                ...
                                <div class="col-lg-6 col-sm-12">
                                  <fieldset>
                                    <input name="tel" type="text" id="phone" placeholder="Phone Number*" required="">
                                  </fieldset>
                                </div>
                                <div class="col-lg-6 col-sm-12">
                                    <fieldset>
